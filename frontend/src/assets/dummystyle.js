export const landingPageStyles = {
  ...
  // Hero section
  heroSection: "max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16",
  heroGrid: "grid grid-cols-1 lg:grid-cols-2 items-center gap-10 lg:gap-14",
  heroLeft: "space-y-6 max-w-2xl",
  ...
  heading: "text-4xl md:text-6xl lg:text-7xl font-black leading-[1.1]",
  ...
  ctaButtons: "flex flex-col sm:flex-row gap-3 sm:gap-4",

  // Buttons
  primaryButton: "group relative px-8 sm:px-10 py-3 sm:py-4 bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white font-bold rounded-2xl overflow-hidden transition-all hover:scale-105 hover:shadow-2xl hover:shadow-violet-200",
  ...
  // Stats
  statsContainer: "flex flex-wrap sm:flex-nowrap items-center gap-6 sm:gap-8 pt-4",
...
export const authStyles = {
  ...
  emailText: "text-sm text-violet-600 font-medium bg-violet-50 px-3 py-2 rounded-lg mt-2",
  form: "space-y-6",
  errorMessage: "text-red-500 text-sm font-medium bg-red-50 border border-red-200 px-4 py-3 rounded-xl",
  submitButton: "w-full py-4 bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white font-black rounded-2xl hover:scale-105 hover:shadow-xl hover:shadow-violet-200 transition-all text-lg disabled:opacity-50 disabled:cursor-not-allowed",
  ...
  // Login method toggle
  loginMethodToggle: "flex bg-gray-100 p-1 rounded-xl mb-6",
  toggleButton: "flex-1 py-2 px-4 text-sm font-medium rounded-lg transition-all",
  active: "bg-white text-violet-600 shadow-sm",
  
  // OTP styles
  otpContainer: "flex gap-3 justify-center mb-6",
  otpInput: "w-12 h-12 text-center text-lg font-bold border-2 border-violet-200 rounded-xl focus:border-violet-500 focus:ring-4 focus:ring-violet-50 transition-all outline-none",
  otpActions: "flex justify-between items-center mt-4",
  resendButton: "text-sm text-violet-600 hover:text-fuchsia-600 font-medium disabled:text-gray-400 disabled:cursor-not-allowed",
  backButton: "text-sm text-gray-600 hover:text-gray-800 font-medium",
  ...
  signupSubmit: "w-full py-4 bg-gradient-to-r from-rose-500 to-pink-600 text-white font-black rounded-2xl hover:scale-105 hover:shadow-xl hover:shadow-rose-200 transition-all text-lg disabled:opacity-50 disabled:cursor-not-allowed",
...
export const modalStyles = {
  ...
  container: "relative flex flex-col bg-white/95 backdrop-blur-xl shadow-2xl rounded-3xl overflow-hidden border border-violet-100 max-w-[900px] w-[90vw] max-h-[85vh]",
  header: "flex items-center justify-between p-6 border-b border-violet-100 bg-gradient-to-r from-white to-violet-50",
  title: "text-xl font-black bg-gradient-to-r from-violet-600 to-fuchsia-600 bg-clip-text text-transparent",
  actionButton: "flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white font-bold rounded-2xl hover:scale-105 transition-all shadow-lg",
